...
class WSPInProgressOrders extends StatefulWidget {
  ...
  State<StatefulWidget> createState() =>
      WSPInProgressOrdersState(uid, role, flag);
}
...
class WSPInProgressOrdersState extends State {
  ...
  WSPInProgressOrdersState(String uid, String role, bool flag) {
    this.uid = uid;
    this.flag = flag;
    this.role = role;
  }
  ...
  Widget build(BuildContext context) {
    if (filter == 'No Filter') {
      return Scaffold(
        appBar: AppBar(title: Text("Orders In Progress" + " ( " + role + " )")),
        body: StreamBuilder(
        ...
        child: SingleChildScrollView(
          ...
          Row(children: [
            Expanded(
              child: Padding(
                ...
                child: Text("Work Proofs", style: TextStyle(fontSize: 15.0)),
              ),
            ),
            Padding(
          ...
          signaturesError == true
              ? Padding(
                  ...
                  child: Text("Please submit atleast 1 signature picture.",
          ...
          Row(children: [
            Expanded(
              ...
              padding: EdgeInsets.only(
                  top: 0.0, bottom: 0.0, left: 20.0, right: 20.0),
              child:
                  Text("Customer Signatures", style: TextStyle(fontSize: 15.0)),
            )),
            Padding(
              padding: EdgeInsets.only(right: 20.0),
              child: IconButton(

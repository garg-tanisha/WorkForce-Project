                                                                  ...
                                                                  Padding(
                                                                      child: RaisedButton(
                                                                          onPressed: () {
                                                                            ...
                                                                            Firestore.instance.collection("placed orders").document(course.documentID).updateData({
                                                                              "status": "In Progress",
                                                                          ...
                                                                          shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(30.0), side: BorderSide(color: Colors.blue, width: 2))),
